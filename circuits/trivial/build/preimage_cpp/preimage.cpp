...
#include "circom.hpp"
#include "calcwit.hpp"
void PreimageKnowledge_0_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void PreimageKnowledge_0_run(uint ctx_index,Circom_CalcWit* ctx);
Circom_TemplateFunction _functionTable[1] = { 
PreimageKnowledge_0_run };
...
ctx->componentMemory[coffset].templateName = "PreimageKnowledge";
...
PreimageKnowledge_0_create(1,0,ctx,"main",0);
PreimageKnowledge_0_run(0,ctx);
}
